...
export const PP_STUDENTS = 7;
export const PRIMARY_STUDENTS = 37;
export const PRIMARY_BOYS = 19;
export const PRIMARY_GIRLS = 25;
export const TOTAL_STUDENTS = 44;
...
export const CLASS_V_EXIST = false;
export const STUDENT_CLASSES = [
  ...
  {name: 'CLASS V', value: 5, year: THIS_YEAR - 10},
];
